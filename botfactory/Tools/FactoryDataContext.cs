...
namespace BotFactory.Tools
{
    public class FactoryDataContext : INotifyPropertyChanged
    {
        ...
        private ObservableCollection<IFactoryQueueElement> _Queue = new ObservableCollection<IFactoryQueueElement>();
        private ObservableCollection<ITestingUnit> _Storage= new ObservableCollection<ITestingUnit>();
        ...
        public IUnitFactory Builder
        {
            ...
            set
            {
                ...
                foreach (IFactoryQueueElement element in _builder.Queue)
                    _Queue.Add(element);
                foreach (ITestingUnit unit in _builder.Storage)
                    _Storage.Add(unit);
                ForceUpdate();
            }
        ...
        public ObservableCollection<IFactoryQueueElement> Queue
        {
            ...
            set
            {
                OnPropertyChanged(nameof(_builder.Queue));
            }
        }
